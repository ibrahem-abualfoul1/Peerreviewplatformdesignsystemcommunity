...
export default function EditQuestion() {
  ...
  const [items, setItems] = useState<QuestionItem[]>([
    { id: 1, textAr: 'ممتاز', textEn: 'Excellent' },
    { id: 2, textAr: 'جيد', textEn: 'Good' },
    { id: 3, textAr: 'مقبول', textEn: 'Fair' },
  ]);
  ...
  const updateItem = (itemId: number, field: 'textAr' | 'textEn', value: string) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className={`text-2xl ${textClass}`}>{t('editQuestion')} - #{id}</h1>
      </div>
